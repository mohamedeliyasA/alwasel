    ...
    >
      ...
      {photos.map((src, i) => (
        <div
          ...
          style={{
            ...
            transition:
              i === current || i === prev ? "opacity 1.6s ease" : "none",
            zIndex: i === current ? 1 : 0,
          }}
        >
          <Image
            src={src}
            alt="AL Wasel project"
            fill
      ...
      <div
        style={{
          ...
          zIndex: 2,
          background:
            "linear-gradient(105deg, rgba(6,14,38,0.82) 0%, rgba(6,14,38,0.38) 52%, rgba(6,14,38,0.08) 100%)",
        }}
      />
      <div
        style={{
          ...
          zIndex: 2,
          background:
            "linear-gradient(to top, rgba(6,14,38,0.65) 0%, transparent 45%)",
        }}
      />
      <div
        style={{
          ...
          zIndex: 2,
          background:
            "linear-gradient(to bottom, rgba(6,14,38,0.28) 0%, transparent 22%)",
        }}
      />
      ...
      >
        <div style={{ maxWidth: 600 }}>
          ...
          >
            Delivering architectural design, authority approvals, MEP
            engineering, and project supervision across Fujairah.
          </p>
          ...
          >
            <Link
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "#1677A0";
                e.currentTarget.style.borderColor = "#1677A0";
                e.currentTarget.style.transform = "translateY(-2px)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "#2196C4";
      ...
      >
        ...
        >
          {[
            ...
            { v: "600+", l: "Projects Completed" },
            { v: "20+", l: "Expert Engineers" },
        ...
        {photos.map((_, i) => (
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              padding: 0,
              background: i === current ? "#4FB8E0" : "rgba(255,255,255,0.25)",
