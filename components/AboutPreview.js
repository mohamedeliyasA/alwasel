    ...
    >
      ...
      >
        ...
        <div>
          ...
          >
            AL Wasel Engineering Consultancy is a fully licensed engineering
            firm headquartered in Fujairah, UAE. We deliver integrated design
            and engineering services with a steadfast commitment to quality,
          ...
          >
            From initial concept through design, authority approvals, and
            on-site supervision, we are your single trusted partner for every
            phase of the built environment in Fujairah.
          </p>
          <div
            className="sr d3"
            style={{
              borderLeft: "3px solid #2196C4",
              paddingLeft: "1rem",
              marginBottom: "2rem",
            }}
          >
            ...
            >
              ...
              <div
                style={{
                  ...
                  color: item.dark ? "rgba(255,255,255,0.55)" : "#5A6A85",
                }}
              >
                {item.l}
              </div>
