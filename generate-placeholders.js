...
const placeholders = [
  { name: 'project_photos_1.jpg', color1: '#1a1a2e', color2: '#0f3460', label: 'Project 01' },
  { name: 'project_photos_2.jpg', color1: '#1a0a00', color2: '#3d1a00', label: 'Project 02' },
  { name: 'project_photos_3.jpg', color1: '#0a1628', color2: '#2c3e50', label: 'Project 03' },
  { name: 'project_photos_4.jpg', color1: '#0a2818', color2: '#1a4a28', label: 'Project 04' },
  { name: 'project_photos_5.jpg', color1: '#280a10', color2: '#4a1a20', label: 'Project 05' },
]
